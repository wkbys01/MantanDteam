...
class MenuAllergensSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('menu_allergens') -> insert([
            ...
            ['menu_id' => 27, 'allergen_id' => 6],

            // 明太子スパゲッティ
            ['menu_id' => 28, 'allergen_id' => 1],
            ['menu_id' => 28, 'allergen_id' => 3],
            ['menu_id' => 28, 'allergen_id' => 4],

            // 和風きのこパスタ
            ['menu_id' => 29, 'allergen_id' => 1],
            ['menu_id' => 29, 'allergen_id' => 3],

            // きのこのクリームスパゲッティ
            ['menu_id' => 30, 'allergen_id' => 1],
            ['menu_id' => 30, 'allergen_id' => 3],
            ...
            ['menu_id' => 41, 'allergen_id' => 4],

            // チーズインハンバーグ
            ['menu_id' => 42, 'allergen_id' => 1],
            ['menu_id' => 42, 'allergen_id' => 3],
            ['menu_id' => 42, 'allergen_id' => 4],
            ...
            ['menu_id' => 45, 'allergen_id' => 4],

            // サーモンのグリル
            ['menu_id' => 46, 'allergen_id' => 1],
            ['menu_id' => 46, 'allergen_id' => 3],
            ...
            // 焼きそば
            ['menu_id' => 48, 'allergen_id' => 1],

            // エビピラフ
            ['menu_id' => 49, 'allergen_id' => 1],
            ['menu_id' => 49, 'allergen_id' => 3],
            ['menu_id' => 49, 'allergen_id' => 6],
            ...
            ['menu_id' => 52, 'allergen_id' => 3],
            ['menu_id' => 52, 'allergen_id' => 4],

            // やみつきチキン南蛮定食
            ['menu_id' => 53, 'allergen_id' => 1],
            ['menu_id' => 53, 'allergen_id' => 3],
            ...
            ['menu_id' => 57, 'allergen_id' => 4],

            // アジフライ定食
            ['menu_id' => 58, 'allergen_id' => 1],
            ['menu_id' => 58, 'allergen_id' => 4],
            ...
            ['menu_id' => 67, 'allergen_id' => 4],

            // 明太子スパゲッティセット
            ['menu_id' => 68, 'allergen_id' => 1],
            ['menu_id' => 68, 'allergen_id' => 3],
            ['menu_id' => 68, 'allergen_id' => 4],
            ...
            ['menu_id' => 73, 'allergen_id' => 4],
            ['menu_id' => 73, 'allergen_id' => 6],
            ...
            ['menu_id' => 78, 'allergen_id' => 4],

            // キッズオムライスプレート
            ['menu_id' => 79, 'allergen_id' => 1],
            ['menu_id' => 79, 'allergen_id' => 4],

            // キッズチーズピザプレート
            ['menu_id' => 80, 'allergen_id' => 1],
            ['menu_id' => 80, 'allergen_id' => 3],
            ...
            ['menu_id' => 83, 'allergen_id' => 3],

            // 唐揚げ
            ['menu_id' => 84, 'allergen_id' => 1],
            ['menu_id' => 84, 'allergen_id' => 4],
            ...
            ['menu_id' => 91, 'allergen_id' => 3],
            ['menu_id' => 91, 'allergen_id' => 4],

            // チキン南蛮弁当
            ['menu_id' => 92, 'allergen_id' => 1],
            ['menu_id' => 92, 'allergen_id' => 3],
            ['menu_id' => 92, 'allergen_id' => 4],
            ...
            ['menu_id' => 97, 'allergen_id' => 4],

            // ビーフカレー弁当
            ['menu_id' => 98, 'allergen_id' => 1],
            ['menu_id' => 98, 'allergen_id' => 3],
            ...
            // キッズハンバーグ弁当
            ['menu_id' => 102, 'allergen_id' => 1],
            ['menu_id' => 102, 'allergen_id' => 3],
            ['menu_id' => 102, 'allergen_id' => 4],

            // まんたん特製オードブル
            ['menu_id' => 103, 'allergen_id' => 1],
            ['menu_id' => 103, 'allergen_id' => 3],
            ['menu_id' => 103, 'allergen_id' => 4],
            ['menu_id' => 103, 'allergen_id' => 6],
            ...
            // ティラミス
            ['menu_id' => 114, 'allergen_id' => 1],
            ['menu_id' => 114, 'allergen_id' => 3],
            ['menu_id' => 114, 'allergen_id' => 4],

            // ベイクドチーズケーキ
            ['menu_id' => 115, 'allergen_id' => 1],
            ...
            // ソフトクリームサンデー（いちご）
            ['menu_id' => 120, 'allergen_id' => 3],
            ['menu_id' => 120, 'allergen_id' => 4],

            // ソフトクリームサンデー（キャラメルソース）
            ['menu_id' => 121, 'allergen_id' => 3],
            ['menu_id' => 121, 'allergen_id' => 4],

            // 和風デザート（白玉あんみつ）
            ['menu_id' => 122, 'allergen_id' => 1],
